...
train_file = "datasets/squad/train-v1.1.json" #os.path.join(home, "datasets", "squad", "train-v1.1.json")
dev_file = "datasets/squad/dev-v1.1.json" #os.path.join(home, "datasets", "squad", "dev-v1.1.json")
test_file = "datasets/squad/dev-v1.1.json" #os.path.join(home, "datasets", "squad", "dev-v1.1.json")
glove_word_file = "datasets/glove/glove.840B.300d.txt" #os.path.join(home, "datasets", "glove", "glove.840B.300d.txt")
...
flags.DEFINE_boolean("use_sru", False, "Whether to use sru")
...
flags.DEFINE_integer("num_steps", 60000, "Number of steps") #120000
flags.DEFINE_integer("checkpoint", 10000, "checkpoint for evaluation") #1000
flags.DEFINE_integer("period", 100, "period to save batch loss") #100
flags.DEFINE_integer("val_num_batches", 150, "Num of batches for evaluation") #150
